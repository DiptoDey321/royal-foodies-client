        ...
        <div className="mt-8">
            <div className="w-[400px]">
                <div className=" p-[30px] flex flex-col items-center justify-center">
                    <img className='w-full' src='' alt="" srcSet="" />
                    <h3 className='text-base tracking-widest'>Lorem ipsum dolor sit amet.</h3>
                    <p className='mt-[30px] text-sm mb-[30px] text-black/60 tracking-[4px] text-left font-light'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quam delectus, et molestiae sed sint hic veniam ut voluptatem quo dolores beatae nulla porro id labore dolor placeat earum. Hic tempora, explicabo repellendus sunt aliquid aut libero voluptatem exercitationem cumque maxime.</p>
                    <button className='border p-3 rounded-full border-[#5B1054] hover:bg-gray-200'>
