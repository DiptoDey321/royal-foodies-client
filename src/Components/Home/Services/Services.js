                ...
                homeServices.map(services =>
                    <div key={services._id} className="border rounded-lg">
                        <div className=" p-[10px] flex flex-col items-center justify-center Roboto">
                            <div className="relative">
                                <PhotoProvider>
                                    <PhotoView src="https://i.ibb.co/zr8S1Q9/breakfst.png">
                                        <img className='w-full' src="https://i.ibb.co/zr8S1Q9/breakfst.png" alt="" />
                                    </PhotoView>
                                </PhotoProvider>
                            ...
                            <p className='mt-[10px] text-sm mb-[20px] text-black/60 tracking-[1px] text-left font-light px-3'>{(services.desc).length > 100 ? (services.desc).slice(0,100) : services.desc } </p>
