...
function OurFeature() {
  return (
    <div className='mx-[10%] my-14'>
        <div className="flex justify-around bg-slate-50 p-8 rounded-lg">
            <div className="service01 flex items-center gap-x-3 border rounded-lg p-4 bg-slate-100 w-[280px]">
